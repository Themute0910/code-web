...
function layThongTinSanPhamTuTable(id) {
    ...
    var tensp = tr[11].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var masanpham = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var mode = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var xuatxu = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var thuonghieu = tr[15].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Thun", "Khoat", "Vay", "Dam", "Somi", "Jean", "short"];
    ...
    s += `
        ...
        <tr>
            ...
            <td>
                <select>
                    ...
                    <option value="tragop" `+(sp.promo.name == 'tragop'?'selected':'')+`>Thành viên</option>
        ...
        <tr>
            <td>Tên sản phẩm:</td>
            <td><input type="text" value="`+sp.detail.tensp+`"></td>
        </tr>
        <tr>
            <td>Mã sản phẩm:</td>
            <td><input type="text" value="`+sp.detail.masanpham+`"></td>
        </tr>
        <tr>
            <td>Mode:</td>
            <td><input type="text" value="`+sp.detail.mode+`"></td>
        </tr>
        <tr>
            <td>Xuất xứ:</td>
            <td><input type="text" value="`+sp.detail.xuatxu+`"></td>
        </tr>
        <tr>
            <td>Thương hiệu:</td>
            <td><input type="text" value="`+sp.detail.thuonghieu+`"></td>
        </tr>
        <tr>
            <td>Size:</td>
