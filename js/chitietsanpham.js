...
window.onload = function () {
    ...
    var tags = ["Thun", "Khoat", "Vay", "Dam", "Somi", "Jean", "short"];
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - Shop online';
    ...
    var s = addThongSo('Tên sản phẩm', sanPhamHienTai.detail.tensp);
    s += addThongSo('Mã sản phẩm', sanPhamHienTai.detail.masanpham);
    s += addThongSo('Mode', sanPhamHienTai.detail.mode);
    s += addThongSo('Xuất xứ', sanPhamHienTai.detail.xuatxu);
    s += addThongSo('Thương hiệu', sanPhamHienTai.detail.thuonghieu);
    ...
    // Hình nhỏ
    addSmallImg("img/products/vay1.jpg");
    addSmallImg("img/products/vay2.jpg");
    addSmallImg("img/products/vay3.jpg");
    addSmallImg("img/products/vay4.jpg");
    addSmallImg("img/products/vay5.jpg");
    addSmallImg("img/products/vay6.jpg");
    addSmallImg("img/products/vay7.jpg");
