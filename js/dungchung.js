...
function addTopNav() {
    // Tạo thẻ <style> và thêm các quy tắc CSS
    ...
    style.innerHTML = `
        ...
        .dropdown-menu {
            ...
            gap: 10px; /* Khoảng cách giữa các mục trong menu */
            padding: 0;
            margin: 0;
            list-style: none;
        }
	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li class="dropdown">
                    <a href="index.html?star=3&sort=rateCount-decrease"><i class="fa fa-th-large"></i> Sản phẩm</a>
                    <ul class="dropdown-menu">
                        <li>
                            <a href="index.html?company=aokhoat">
                                <img src="img/products/aokhoat5.png" class="menu-icon"> Áo Khoát Nam Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=aothun">
                                <img src="img/products/aothun8.png" class="menu-icon"> Áo Thun Nam Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=chanvay">
                                <img src="img/products/vay5.jpg" class="menu-icon"> Chân Váy Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=dam">
                                <img src="img/products/dam10.jpg" class="menu-icon"> Áo Đầm Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=somi">
                                <img src="img/products/somi26.jpg" class="menu-icon"> Áo Sơ Mi Nam Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=jean">
                                <img src="img/products/jean27.jpg" class="menu-icon"> Quần Jean Nam Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=short">
                                <img src="img/products/short2.jpg" class="menu-icon"> Quần Short Nam Nữ
                            </a>
                        </li>
                        <li>
                            <a href="index.html?company=phukien">
                                <img src="img/products/tui3.jpg" class="menu-icon"> Phụ Kiện Thời Trang
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://bazaarvietnam.vn/xu-huong-thoi-trang-thu-dong-2024/#post-2850693">Top 9 xu hướng thời trang hot nhất mùa Thu Đông 2024</a></li>
                        <li><a href="https://afamily.vn/cong-thuc-dien-ao-thun-theo-phong-cach-toi-gian-20240822100845772.chn">Công thức diện áo thun theo phong cách tối giản</a></li>
                        <li><a href="https://afamily.vn/mau-vay-khong-bao-gio-loi-mot-20240823101223939.chn">Mẫu váy không bao giờ lỗi mốt</a></li>
                        <li><a href="https://eva.vn/tin-tuc-thoi-trang/hoa-hau-xuan-hanh-duoc-sash-factor-du-doan-lot-vao-top-5-miss-cosmo-2024-c290a605871.html">Hoa hậu Xuân Hạnh được Sash Factor dự đoán lọt vào Top 5 Miss Cosmo 2024</a></li>
                        <li><a href="https://eva.vn/tin-tuc-thoi-trang/tuong-san-lot-do-hat-tieng-thai-vao-top-3-tai-nang-hoa-hau-chuyen-gioi-quoc-te-c290a605781.html">Tường San hát tiếng Thái vào top 3 tài năng Hoa hậu Chuyển giới Quốc tế</a></li>
                    </ul>
                </li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo-2.jpg" alt="Trang chủ" title="Trang chủ">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">DOKMA Store</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">HaiDev</span></p>
    </div>`);
}
        ...
        s.innerHTML = `
			(function () {
				...
				for (var li of li_s) {
					...
					switch (loai) {
						case "Tên sản phẩm:":
							result.detail.tensp = giatri.replace('"', "'");
							break;
						case "Mã sản phẩm:":
							result.detail.masanpham = giatri;
							break;
						case "Mode:":
							result.detail.mode = giatri;
							break;
						case "Xuất xứ:":
							result.detail.xuatxu = giatri;
							break;
						case "Thương hiệu:":
							result.detail.thuonghieu = giatri;
							break;
						case "Size:":
