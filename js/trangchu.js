window.onload = function () {
	...
	var company = ["aokhoat.png", "aothun.png", "chanvay.png", "dam.png", "somi.png", "jean.png","short.png", "phukien.png", "lot.png" ];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('Thành viên giảm 20%', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
	...
	// Thêm chọn mức giá
	addPricesRange(0, 500000);
	addPricesRange(500000, 1000000);
	addPricesRange(1000000, 2000000);
	addPricesRange(2000000, 5000000);
	addPricesRange(5000000, 0);
